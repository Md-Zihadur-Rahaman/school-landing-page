import bannerRight from '../assets/banner-right.svg'
import studentBanner from '../assets/student-banenr.svg'
import userBanner from '../assets/user-banner.svg'
import userLogoBanner from '../assets/user-logo-banner.svg'
import problemSolving from '../assets/problem-solving.svg'
import liveChat from '../assets/live-chat.svg'
import groupReading from '../assets/group-reading.svg'
import tenKCourses from '../assets/10k-course.svg'
import handOnActivities from '../assets/handonactivities.svg'
  ...
  return (
    <>
      ...
      <section className='max-w-7xl lg:mx-auto h-full lg:h-[605px] flex flex-col md:flex-row justify-between items-center gap-10 lg:gap-0 rounded-none md:rounded-[50px] bg-banner_bg_color relative  lg:mb-20 py-14 md:py-0 px-4 lg:px-0 md:m-4 '>
        ...
        {/* right bar section */}
        <figure className='absolute inset-y-0 right-0 h-full '>
          <img
